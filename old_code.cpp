...
/*------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
BOUNDING BOX FOR MULTIPLE FILES IN VIEWER BUT CANNOT SAVE THE VIEWER - SURFACE REPRESENTATION 30/10/2019*/
//#include <vtkAutoInit.h>         
//VTK_MODULE_INIT(vtkRenderingOpenGL);
//VTK_MODULE_INIT(vtkInteractionStyle);
//VTK_MODULE_INIT(vtkRenderingFreeType);
...
//		boxId += std::to_string(counter);
//		viewer.addCube(bboxT, bboxQ, whd(0), whd(1), whd(2), boxId);
//		viewer.setShapeRenderingProperties(pcl::visualization::PCL_VISUALIZER_REPRESENTATION, pcl::visualization::PCL_VISUALIZER_REPRESENTATION_SURFACE, boxId);
//		double R = ((double)rand() / (RAND_MAX));
//		double G = ((double)rand() / (RAND_MAX));
//		double B = ((double)rand() / (RAND_MAX));
//		viewer.setShapeRenderingProperties(pcl::visualization::PCL_VISUALIZER_COLOR, R, G, B, boxId);
//
//		counter++;
//	}
//
